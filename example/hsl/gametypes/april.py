...
async def install(
    self, serverName: str, serverPath: str, serverJarPath: str, data: dict
):  # -> tuple[str, Literal['vanilla'], str, Any, dict[Any, Any]] | ...:# -> tuple[str, Literal['vanilla'], str, Any, dict[Any, Any]] | ...:# -> tuple[str, Literal['vanilla'], str, Any, dict[Any, Any]] | ...:# -> tuple[str, Literal['vanilla'], str, Any, dict[Any, Any]] | ...:
    serverType = "vanilla"
