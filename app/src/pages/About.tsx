...
export default function About() {
  ...
  return <motion.section className="page-shell" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
    <header className="page-header"><div><span className="page-kicker">APPLICATION</span><h1>关于 HSL</h1><p>版本、构建编号与开源许可</p></div></header>
    <div className="page-body about-layout">
      <aside className="surface about-product">
        <img src="/HSL.png" alt="HSL" />
        <div><h2>Hikari Server Launcher 2</h2><p>Minecraft 服务端管理工具</p></div>
      ...
      <div className="about-content">
        <article className="surface content-card"><span className="section-label">OPEN SOURCE</span><h2>GNU GPL v3.0</h2><p>允许在 GPLv3 条款下使用、修改和分发本软件。</p></article>
